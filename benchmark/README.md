...
3. **performance_comparison.png**: Plot of Runtime/N vs N (shows scaling behavior)
4. **absolute_runtime_comparison.png**: Plot of absolute runtime vs N
...
The benchmarks test the following array lengths:
- Powers of 2: 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768
